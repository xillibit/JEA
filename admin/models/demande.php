 ...
 * @subpackage  com_jea
 */
class JeaModelDemande extends JModelAdmin
{
    /**
    ...
    public function getForm($data = array(), $loadData = true)
    {
        ...
        $form = $this->loadForm('com_jea.demande', 'demande', array('control' => 'jform', 'load_data' => $loadData));
    ...
    */
    ...
    protected function loadFormData()
    {
        ...
        $data = JFactory::getApplication()->getUserState('com_jea.edit.demande.data', array());
     ...
     * @see JModel::getTable()
     */
    public function getTable($name = 'demandes', $prefix = 'Table', $options = array())
    {
