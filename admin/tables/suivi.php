 ...
 *
 * @version     $Id: properties.php 426 2013-07-17 14:12:10Z ilhooq $
 ...
 * @subpackage  com_jea
 */
class TableSuivi extends JTable
{
    /**
     * Constructor
    ...
    {
        parent::__construct('#__jea_suivi', 'id', $db);
    }
    ...
    {
        $k = $this->_tbl_key;
        return 'com_jea.suivi.' . (int) $this->$k;
    }
